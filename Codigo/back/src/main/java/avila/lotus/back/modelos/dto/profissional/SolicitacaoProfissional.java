...
public record SolicitacaoProfissional(
        ...
        @NotBlank(message = "codAutenticacao não pode ser vazio") @Size(min = 4, message = "O código de autenticação deve ter pelo menos 4 caracteres") String codAutenticacao) {
}
